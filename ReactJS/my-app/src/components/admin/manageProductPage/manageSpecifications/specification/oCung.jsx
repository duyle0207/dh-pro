                        ...
                        <div className="container-fluid">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-4 text-dark my-4">
                                    <h2>Thao tác: {this.state.oCung.id === '' ? <span class="badge badge-info">Thêm</span> : <span class="badge badge-warning">Chỉnh sửa</span>}</h2>
                                    <form onSubmit={this.insert}>
                                        ...
                                        {this.state.oCung.id === '' ? "" : <button type="button" onClick={this.handeClearBtn} class="btn btn-danger my-2 mx-2"><b>Hủy</b></button>}
                                    </form>
                                </div>
                            </div>
