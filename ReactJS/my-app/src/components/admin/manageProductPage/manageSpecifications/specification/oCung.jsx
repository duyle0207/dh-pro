...
class oCung extends Component {
    ...
    handleChange(event) {
        var oCung = this.state.oCung;
        oCung[event.target.name] = event.target.value;
                        ...
                        <div className="container-fluid">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-4 text-dark my-4">
                                    <h2>Thao tác: {this.state.oCung.id === '' ? <span class="badge badge-info">Thêm</span> : <span class="badge badge-warning">Chỉnh sữa</span>}</h2>
                                    <form onSubmit={this.insert}>
                                        <div className="form-group my-2 mx-2">
                                            <label><b>Tên ổ cứng: </b></label>
                                            <input className="form-control" name="tenOCung" placeholder="Tên ổ cứng" value={this.state.oCung.tenOCung} onChange={this.handleChange} required></input>
                                        </div>
                                        <div className="form-group my-2 mx-2">
                                            <label><b>Dung lượng: </b></label>
                                            <input className="form-control" type="number" min="2" max="1000" name="dungLuong" placeholder="Dung lượng" value={this.state.oCung.dungLuong} onChange={this.handleChange} required></input>
                                        </div>
                                        {this.state.error ?
                                        ...
                                        {this.state.oCung.id === '' ? "" : <button type="button" onClick={this.handeClearBtn} class="btn btn-danger my-2 mx-2"><b>Chuyễn sang thao tác thêm</b></button>}
                                    </form>
                                </div>
                            </div>
